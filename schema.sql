-- Brideltte Database Schema
-- MySQL 5.7+ / 8.x Compatible

CREATE DATABASE IF NOT EXISTS brideltte_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE brideltte_db;
...
(2, 'Royal Palace Hall', 'Venues', 'A luxurious wedding venue with stunning architecture, crystal chandeliers, and capacity for up to 500 guests. Perfect for grand celebrations.', 'Cairo, Egypt', '+201234567890', 'info@royalpalace.com', 'https://royalpalace.com', '$$$', '[]', 4.80, 24, 1),
(3, 'Golden Lens Photography', 'Photography', 'Award-winning wedding photography studio specializing in candid moments and artistic portraits. 10+ years of experience capturing love stories.', 'Alexandria, Egypt', '+201098765432', 'hello@goldenlens.com', 'https://goldenlens.com', '$$', '[]', 4.90, 31, 1),
(4, 'Elegant Events Catering', 'Catering', 'Premium catering service offering diverse cuisines from traditional Egyptian to international gourmet. Custom menus for every taste and budget.', 'Giza, Egypt', '+201555666777', 'book@elegantevents.com', NULL, '$$-$$$', '[]', 4.50, 18, 1);
...
(5, 3, 3, 5, 'Amazing food and service! The buffet was incredible and all guests were satisfied. Highly recommended for any wedding celebration.');
